...
namespace Original_Gragas
{
    class Program
    {
        ...
        static void OnLoad(EventArgs args)
        {
            ...
            int i = 1;
            foreach (Obj_AI_Hero unit in HeroManager.Enemies)
            {
            ...
            R_Auto = Ult.AddSubMenu(new Menu("Automatic ult settings", "R_Auto"));
            R_Auto.AddItem(new MenuItem("autoult", "Use Ult automatically").SetValue(true));
            R_Auto.AddItem(new MenuItem("killsteal", "Use ult to killsteal").SetValue(true));
